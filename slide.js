...
function showContactForm() {
    contactFormPopup.classList.remove('hidden'); // Remove the hidden class
}

// Function to hide the popup
function hideContactForm() {
    contactFormPopup.classList.add('hidden'); // Add the hidden class
}
...
closePopupButton.addEventListener('click', hideContactForm);


// our project javascript
...
cardContainers.forEach((cardContainer) => {
    cardContainer.addEventListener('mouseover', (event) => {
        ...
        if (card) {
            // Toggle content or display additional information here
            console.log(`Card ${card.dataset.card} hovered!`);
        }
    });
});